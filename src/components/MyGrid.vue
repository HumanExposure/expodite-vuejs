<template>
    <ag-grid-vue style="width: 600px; height:768px;"
                 class="ag-theme-balham right-bar"
                 id="right-bar"
...
<script>
    ...
    export default {
        ...
        beforeMount() {
            this.columnDefs = [
                {headerName: 'Chemical Name', field: 'PREFERRED_NAME', sortable: true, filter: true},
                {headerName: 'DTXSID', field: 'DTXSID', sortable: true, filter: true},
